...
export default function BagList({ gender, age }) {
  ...
  if (filtered.length === 0)
    return (
      <p className="mt-6 text-center text-[#4B5563] font-body">
  ...
  return (
    <div className="mt-10 px-4">
      <h2 className="text-3xl font-heading text-[#1E1B4B] mb-8 text-center">
        Recommended Bags
      </h2>
