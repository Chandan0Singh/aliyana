  ...
  return (
    <div className="min-h-screen bg-white px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        {/* Bags */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 h-[65vh] overflow-auto pr-[2rem] custom-scrollbar w-full">
          {filteredBags.map((bag) => (
            ...
            >
              ...
              {bag.sale && (
                <p className="text-red-500 mt-1">Sale: {bag.sale}</p>
              )}
