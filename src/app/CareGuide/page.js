  ...
  return (
    <div className="min-h-screen bg-[#FDF4FF] text-[#1E1B4B] px-4 sm:px-6 py-10 sm:py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-serif font-bold text-center mb-8 sm:mb-10">
          🧼 Bag Care Guide
        </h1>
        ...
        {/* Cleaning Tips */}
        <h2 className="text-xl sm:text-2xl font-semibold mt-8 mb-4">🧽 Cleaning Tips</h2>
        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
          ...
          <li>Never soak your bag in water. Spot clean only.</li>
        </ul>

        {/* Storage Advice */}
        <h2 className="text-xl sm:text-2xl font-semibold mt-8 mb-4">📦 Storage Advice</h2>
        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
        ...
        {/* Things to Avoid */}
        <h2 className="text-xl sm:text-2xl font-semibold mt-8 mb-4">🚫 Things to Avoid</h2>
        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
        ...
        <p className="text-base sm:text-lg mt-8 leading-relaxed">
