    ...
    <>
      ...
      <div className="relative h-screen w-full overflow-hidden bg-[#FDF4FF]">
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
          <h1 className="text-[5rem] md:text-[7rem] leading-none font-serif font-bold tracking-widest text-[#1E1B4B]">
            Aliyana
          </h1>
          <p className="mt-4 text-xl text-[#1E1B4B]">Aliyana Luxe</p>
      ...
      <section className="bg-white text-black">
        <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-4xl font-serif text-[#1E1B4B] font-semibold mb-4">
              Timeless Elegance
            </h2>
            ...
            <Link href="/collection" className="text-[#C084FC] font-medium hover:underline">
              Explore Collection
            </Link>
          </div>
      ...
      {/* Newsletter Section */}
      <div className="bg-[#F3E8FF] mt-20 px-6 py-16 text-center rounded-xl shadow-inner">
        <h3 className="text-3xl font-serif text-[#1E1B4B] mb-4">Get Exclusive Updates</h3>
        <p className="text-gray-600 mb-6">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {["Custom Engraving", "Private Session", "In-store Pickup"].map((title, idx) => (
      ...
      {/* Conditional Quiz Section (Optional) */}
      {/* <div className="p-6">
